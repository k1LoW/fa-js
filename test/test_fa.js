...
describe('fa.allow', function(){
  ...
  it('should assert alpha', function(){
    ...
    testset.forEach(function(entry) {
      ...
      expect(fa.alpha(entry['input']).assert()).to.eq(entry['expect']);
    });
  });
  ...
  it('should assert digit', function(){
    ...
    testset.forEach(function(entry) {
      ...
      expect(fa.digit(entry['input']).assert()).to.eq(entry['expect']);
    });
  });
  ...
  it('should assert space', function(){
    ...
    testset.forEach(function(entry) {
      ...
      expect(fa.space(entry['input']).assert()).to.eq(entry['expect']);
    });
  });
  ...
  it('should assert symbol', function(){
    ...
    testset.forEach(function(entry) {
      ...
      expect(fa.symbol(entry['input']).assert()).to.eq(entry['expect']);
    });
  });
  ...
  it('should assert hyphen', function(){
    ...
    testset.forEach(function(entry) {
      ...
      expect(fa.hyphen(entry['input']).assert()).to.eq(entry['expect']);
    });
  });
  ...
  it('should assert zenkaku', function(){
    ...
    testset.forEach(function(entry) {
      ...
      expect(fa.zenkaku(entry['input']).assert()).to.eq(entry['expect']);
    });
  });
  ...
  it('should assert hiragana', function(){
    ...
    testset.forEach(function(entry) {
      ...
      expect(fa.hiragana(entry['input']).assert()).to.eq(entry['expect']);
    });
  });
  ...
  it('should assert katakana', function(){
    ...
    testset.forEach(function(entry) {
      ...
      expect(fa.katakana(entry['input']).assert()).to.eq(entry['expect']);
    });
  });
  ...
  it('should assert zenkaku_alpha', function(){
    ...
    testset.forEach(function(entry) {
      ...
      expect(fa.zenkaku_alpha(entry['input']).assert()).to.eq(entry['expect']);
    });
  });
  ...
  it('should assert zenkaku_digit', function(){
    ...
    testset.forEach(function(entry) {
      ...
      expect(fa.zenkaku_digit(entry['input']).assert()).to.eq(entry['expect']);
    });
  });
  ...
  it('should assert zenkaku_space', function(){
    ...
    testset.forEach(function(entry) {
      ...
      expect(fa.zenkaku_space(entry['input']).assert()).to.eq(entry['expect']);
    });
  });
  ...
  it('should assert zenkaku_symbol', function(){
    ...
    testset.forEach(function(entry) {
      ...
      expect(fa.zenkaku_symbol(entry['input']).assert()).to.eq(entry['expect']);
    });
  });
...
describe('fa.allow', function(){
  ...
  it('should check notEmpty', function(){
    ...
    testset.forEach(function(entry) {
      expect(fa.set(entry['input']).allow('notEmpty').assert()).to.eq(entry['expect']);
  ...
  it('should check int', function(){
    ...
    testset.forEach(function(entry) {
      expect(fa.set(entry['input']).allow('int').assert()).to.eq(entry['expect']);
